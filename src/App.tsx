...
function App() {
  ...
  const [isWantToRember, setIsWantToRember] = useState(false);
      ...
      >
        ...
        >
          ...
          >
            <Typography
              variant="body2"
              sx={{ color: "#9c9fa3", fontWeight: 500, mb: 0.2 }}
            >
              Email
            </Typography>
            <TextField
            ...
            <Typography
              variant="body2"
              sx={{ color: "#9c9fa3", fontWeight: 500, mt: 0.6, mb: 0.2 }}
            >
              Password
            </Typography>
            <TextField
            ...
            <Button
              ...
              sx={{
                ...
                mb: 0.2,
                textTransform: "none",
                boxShadow: "0 1.5px 4px 0 rgba(33,39,46,.06)",
                ":hover": { bgcolor: "#191e24" },
              }}
            >
              Sign in
            </Button>
          ...
          <Divider sx={{ my: 3 }}>
            <span style={{ color: "#c6cace", fontSize: "0.97rem" }}>or</span>
          </Divider>
          <Box
            sx={{
              textAlign: "center",
      ...
      >
        <Button
          ...
          sx={{
            ...
            textTransform: "none",
            ":hover": { boxShadow: "0 1.3px 18px 0 rgba(33,39,46,.12)" },
          }}
        >
          Report a Bug
        </Button>
